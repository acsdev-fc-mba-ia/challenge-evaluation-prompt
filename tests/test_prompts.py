...
class TestPrompts:
    ...
    def test_prompt_has_few_shot_examples(self, prompt_data):
        ...
        system_prompt = prompt_data.get("system_prompt")
        match_simple  = any(indicator in system_prompt for indicator in ["Exemplos de Complexidade SIMPLES"])
        match_medium  = any(indicator in system_prompt for indicator in ["Exemplos de Complexidade MÉDIA"])
        match_complex = any(indicator in system_prompt for indicator in ["Exemplos de Complexidade COMPLEXA"])
